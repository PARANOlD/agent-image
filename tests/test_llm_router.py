...
@pytest.mark.parametrize("text,want_command,want_number", [
    ("what are my active PRs right now?", "pr_list", None),
    ("gimme my open pull reqs", "pr_list", None),
    ("anything waiting on review?", "pr_list", None),
    ("whats the status of PR 1", "pr_status", 1),
    ("can you check on pull request number 1 for me", "pr_status", 1),
    ("is #1 merged yet", "pr_status", 1),
    ("how do I reverse a string in C#", None, None),
    ("thanks!", None, None),
])
def test_router_classifies_correctly(text, want_command, want_number):
